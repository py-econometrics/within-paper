...
#table(
  ...
  [`synthetic-complete`], [#miss], [#miss], [#miss], [#miss], [#miss],
  [`synthetic-uniform-easy`], [#miss], [#miss], [#miss], [#miss], [#miss],
  [`synthetic-uniform-hard`], [#miss], [#miss], [#miss], [#miss], [#miss],
  [`synthetic-uniform-harder`], [#miss], [#miss], [#miss], [#miss], [#miss],
  [`synthetic-assortative`], [#miss], [#miss], [#miss], [#miss], [#miss],
  table.hline(stroke: 0.8pt + table-rule),
)
