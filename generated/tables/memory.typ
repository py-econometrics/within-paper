...
#table(
  ...
  [simple (dense graph)], [$8.57 times 10^(-1)$ (1.00)], [307 MB], [363 MB],
  [difficult (sparse graph)], [$1.30 times 10^(-3)$ (1.00)], [309 MB], [356 MB],
  table.hline(stroke: 0.35pt + table-light-rule),
  table.cell(colspan: 4, fill: table-head-fill)[#emph[1M observations]],
  [simple (dense graph)], [$8.57 times 10^(-1)$ (1.00)], [660 MB], [992 MB],
  [difficult (sparse graph)], [$1.67 times 10^(-5)$ (1.00)], [648 MB], [835 MB],
  table.hline(stroke: 0.8pt + table-rule),
)
