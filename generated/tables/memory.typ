...
#table(
  ...
  [simple (well-connected)], [#miss], [306 MiB], [359 MiB],
  [difficult (near-nested)], [#miss], [318 MiB], [354 MiB],
  table.hline(stroke: 0.35pt + table-light-rule),
  table.cell(colspan: 4, fill: table-head-fill)[#emph[1M observations]],
  [simple (well-connected)], [#miss], [679 MiB], [1,000 MiB],
  [difficult (near-nested)], [#miss], [702 MiB], [884 MiB],
  table.hline(stroke: 0.8pt + table-rule),
)
