...
#table(
  ...
  [simple (well-connected)], [#miss], [360 MiB], [415 MiB],
  [difficult (near-nested)], [#miss], [368 MiB], [390 MiB],
  table.hline(stroke: 0.35pt + table-light-rule),
  table.cell(colspan: 4, fill: table-head-fill)[#emph[1M observations]],
  [simple (well-connected)], [#miss], [961 MiB], [1,230 MiB],
  [difficult (near-nested)], [#miss], [917 MiB], [1,061 MiB],
  table.hline(stroke: 0.8pt + table-rule),
)
