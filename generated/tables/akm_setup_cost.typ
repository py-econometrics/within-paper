...
#table(
  ...
  [`akm_mobility_3`], [$3.67 times 10^(-3)$ (0.87)], [0.039s], [0.150s], [0.047s], [0.254s],
  [`akm_mobility_4`], [$1.07 times 10^(-3)$ (0.61)], [0.053s], [0.131s], [0.057s], [0.250s],
  [`akm_mobility_5`], [$1.10 times 10^(-4)$ (0.52)], [0.057s], [0.123s], [0.067s], [0.231s],
  [`akm_mobility_6`], [$4.82 times 10^(-5)$ (0.29)], [0.067s], [0.057s], [0.073s], [0.176s],
  table.hline(stroke: 0.8pt + table-rule),
)
