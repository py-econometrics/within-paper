...
#table(
  ...
  [`akm_mobility_3`], [$3.67 times 10^(-3)$ (0.87)], [18.0s], [capped (0/3)], [1.02s], [0.444s], [2.58s], [2.03s],
  [`akm_mobility_4`], [$1.07 times 10^(-3)$ (0.61)], [54.5s], [capped (0/3)], [1.37s], [0.404s], [5.83s], [2.93s],
  [`akm_mobility_5`], [$1.10 times 10^(-4)$ (0.52)], [capped (0/3)], [capped (0/3)], [2.10s], [0.382s], [6.53s], [3.37s],
  [`akm_mobility_6`], [$4.82 times 10^(-5)$ (0.29)], [capped (0/3)], [capped (0/3)], [3.10s], [0.365s], [7.25s], [4.29s],
  table.hline(stroke: 0.8pt + table-rule),
)
