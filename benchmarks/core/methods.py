...
METHODS = {
    ...
    "torch-cpu": Method("PyFixest", "Torch LSMR", "factor-pair", "#16a34a", "D"),
    "torch-mps": Method("PyFixest", "Torch LSMR", "factor-pair", "#16a34a", "D"),
    "torch-cuda": Method("PyFixest", "Torch LSMR", "factor-pair", "#16a34a", "D"),
